...
W_fc1 = tf.Variable(tf.truncated_normal(shape=[8 * 8 * 256, 256], stddev=0.01))
...
W_fc1_2 = tf.Variable(tf.truncated_normal(shape=[256, 128], stddev=0.01))
B_fc1_2 = tf.Variable(tf.constant(0.1, shape=[128]))
H_fc1_2 = tf.nn.relu(tf.matmul(H_fc1_drop, W_fc1_2) + B_fc1_2)
H_fc1_2_drop = tf.nn.dropout(H_fc1_2, dropout_prob)

W_fc1_3 = tf.Variable(tf.truncated_normal(shape=[128, 64], stddev=0.01))
B_fc1_3 = tf.Variable(tf.constant(0.1, shape=[64]))
H_fc1_3 = tf.nn.relu(tf.matmul(H_fc1_2_drop, W_fc1_3) + B_fc1_3)
H_fc1_3_drop = tf.nn.dropout(H_fc1_3, dropout_prob)

W_fc2 = tf.Variable(tf.truncated_normal(shape=[64, 10], stddev=0.01))
B_fc2 = tf.Variable(tf.constant(0.1, shape=[10]))
logits = tf.matmul(H_fc1_3_drop,W_fc2) + B_fc2
