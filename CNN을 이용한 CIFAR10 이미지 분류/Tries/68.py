...
#핵심 Neural Network
W1 = tf.Variable(tf.truncated_normal(shape=[5, 5, 3, 32], stddev=0.01))
...
W2 = tf.Variable(tf.truncated_normal(shape=[5, 5, 32, 64], stddev=0.01))
